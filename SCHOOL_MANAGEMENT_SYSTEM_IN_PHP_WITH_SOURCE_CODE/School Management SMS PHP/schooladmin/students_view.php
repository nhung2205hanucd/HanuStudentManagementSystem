...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"IF(    CHAR_LENGTH(`course1`.`Name`), CONCAT_WS('',   `course1`.`Name`), '') /* Course */" => "Course",
	...
	$x->ColCaption = array("FullName", "Gender", "Death Of Birth", "Photo", "RegNo", "Class", "Stream", "Course", "DOJ", "Category", "AcademicYear", "TotalFees", "AdvanceFees", "Balance", "Parent");
	$x->ColFieldName = array('FullName', 'Gender', 'DOB', 'Photo', 'RegNo', 'Class', 'Stream', 'Course', 'DOJ', 'Category', 'AcademicYear', 'TotalFees', 'AdvanceFees', 'Balance', 'Parent');
