...
function students_insert(){
	...
	sql('insert into `students` set       `FullName`=' . (($data['FullName'] !== '' && $data['FullName'] !== NULL) ? "'{$data['FullName']}'" : 'NULL') . ', `Gender`=' . (($data['Gender'] !== '' && $data['Gender'] !== NULL) ? "'{$data['Gender']}'" : 'NULL') . ', `DOB`=' . (($data['DOB'] !== '' && $data['DOB'] !== NULL) ? "'{$data['DOB']}'" : 'NULL') . ', ' . ($data['Photo'] != '' ? "`Photo`='{$data['Photo']}'" : '`Photo`=NULL') . ', `RegNo`=' . (($data['RegNo'] !== '' && $data['RegNo'] !== NULL) ? "'{$data['RegNo']}'" : 'NULL') . ', `Class`=' . (($data['Class'] !== '' && $data['Class'] !== NULL) ? "'{$data['Class']}'" : 'NULL') . ', `Stream`=' . (($data['Stream'] !== '' && $data['Stream'] !== NULL) ? "'{$data['Stream']}'" : 'NULL') . ', `Course`=' . (($data['Course'] !== '' && $data['Course'] !== NULL) ? "'{$data['Course']}'" : 'NULL') . ', `DOJ`=' . (($data['DOJ'] !== '' && $data['DOJ'] !== NULL) ? "'{$data['DOJ']}'" : 'NULL') . ', `Category`=' . (($data['Category'] !== '' && $data['Category'] !== NULL) ? "'{$data['Category']}'" : 'NULL') . ', `AcademicYear`=' . (($data['AcademicYear'] !== '' && $data['AcademicYear'] !== NULL) ? "'{$data['AcademicYear']}'" : 'NULL') . ', `TotalFees`=' . (($data['TotalFees'] !== '' && $data['TotalFees'] !== NULL) ? "'{$data['TotalFees']}'" : 'NULL') . ', `AdvanceFees`=' . (($data['AdvanceFees'] !== '' && $data['AdvanceFees'] !== NULL) ? "'{$data['AdvanceFees']}'" : 'NULL') . ', `Balance`=' . (($data['Balance'] !== '' && $data['Balance'] !== NULL) ? "'{$data['Balance']}'" : 'NULL') . ', `Parent`=' . (($data['Parent'] !== '' && $data['Parent'] !== NULL) ? "'{$data['Parent']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function students_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `students` set       `FullName`=' . (($data['FullName'] !== '' && $data['FullName'] !== NULL) ? "'{$data['FullName']}'" : 'NULL') . ', `Gender`=' . (($data['Gender'] !== '' && $data['Gender'] !== NULL) ? "'{$data['Gender']}'" : 'NULL') . ', `DOB`=' . (($data['DOB'] !== '' && $data['DOB'] !== NULL) ? "'{$data['DOB']}'" : 'NULL') . ', ' . ($data['Photo']!='' ? "`Photo`='{$data['Photo']}'" : ($_REQUEST['Photo_remove'] != 1 ? '`Photo`=`Photo`' : '`Photo`=NULL')) . ', `RegNo`=' . (($data['RegNo'] !== '' && $data['RegNo'] !== NULL) ? "'{$data['RegNo']}'" : 'NULL') . ', `Class`=' . (($data['Class'] !== '' && $data['Class'] !== NULL) ? "'{$data['Class']}'" : 'NULL') . ', `Stream`=' . (($data['Stream'] !== '' && $data['Stream'] !== NULL) ? "'{$data['Stream']}'" : 'NULL') . ', `Course`=' . (($data['Course'] !== '' && $data['Course'] !== NULL) ? "'{$data['Course']}'" : 'NULL') . ', `DOJ`=' . (($data['DOJ'] !== '' && $data['DOJ'] !== NULL) ? "'{$data['DOJ']}'" : 'NULL') . ', `Category`=' . (($data['Category'] !== '' && $data['Category'] !== NULL) ? "'{$data['Category']}'" : 'NULL') . ', `AcademicYear`=' . (($data['AcademicYear'] !== '' && $data['AcademicYear'] !== NULL) ? "'{$data['AcademicYear']}'" : 'NULL') . ', `TotalFees`=' . (($data['TotalFees'] !== '' && $data['TotalFees'] !== NULL) ? "'{$data['TotalFees']}'" : 'NULL') . ', `AdvanceFees`=' . (($data['AdvanceFees'] !== '' && $data['AdvanceFees'] !== NULL) ? "'{$data['AdvanceFees']}'" : 'NULL') . ', `Balance`=' . (($data['Balance'] !== '' && $data['Balance'] !== NULL) ? "'{$data['Balance']}'" : 'NULL') . ', `Parent`=' . (($data['Parent'] !== '' && $data['Parent'] !== NULL) ? "'{$data['Parent']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function students_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	$lookup_fields = array(  'Class' => array('classes', 'Class'), 'Stream' => array('streams', 'Stream'), 'Course' => array('Courses', 'Course'), 'Category' => array('studentcategories', 'Category'), 'AcademicYear' => array('sessions', 'AcademicYear'), 'TotalFees' => array('schoolmoney', 'TotalFees'), 'Parent' => array('parents', 'Parent'));
